             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab xdeus
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab xdeus
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab xdeus
		{
