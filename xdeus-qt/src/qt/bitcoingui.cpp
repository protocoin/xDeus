    ...
    rpcConsole(0)
{
    ...
    QString windowTitle = tr("xderStake") + " - " + tr("Wallet");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a xderStake address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About xderStake"), this);
    aboutAction->setToolTip(tr("Show information about xderStake"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for xderStake"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("xderStake client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xderStake network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid xderStake address or malformed URI parameters."));
    }
...
void BitcoinGUI::listThemes(QStringList& themes)
{
    ...
    // or use default theme - xderBlue
    if (selectedTheme=="") {
        selectedTheme = "xderBlue";
    }
    // load it!
